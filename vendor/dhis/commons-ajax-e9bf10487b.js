...
function DataDictionary()
{
    ...
    this.loadDataElementGroups = function( jQuerySelectionString )
    {
        ...
        {
            jQuery.getJSON( '../web-commons-ajax-json/getDataElementGroups.action', function( json )
            {
    ...
    this.loadDataElementsByGroup = function( id, jQuerySelectionString )
    {
        ...
        if ( des == null )
        {
            ...
            jQuery.getJSON( '../web-commons-ajax-json/getDataElements.action', {
                id : id
            }, function( json )
            {
    ...
    this.loadIndicatorGroups = function( jQuerySelectionString )
    {
        ...
        {
            jQuery.getJSON( '../web-commons-ajax-json/getIndicatorGroups.action', function( json )
            {
                target.append( '<option value="' + ALL_KEY + '">ALL</option>' );
    ...
    this.loadIndicatorsByGroup = function( id, jQuerySelectionString )
    {
        ...
        if ( ins == null )
        {
            ...
            jQuery.getJSON( '../web-commons-ajax-json/getIndicators.action', {
                id : id
            }, function( json )
            {
    ...
    this.loadCategoryOptionComboByDE = function( id, jQuerySelectionString )
    {
        ...
        if ( options == null )
        {
            ...
            jQuery.getJSON( '../web-commons-ajax-json/getCategoryOptionCombos.action', {
                id : id
            }, function( json )
            {
    ...
    this.loadOperands = function( jQuerySelectionString, params )
    {
        ...
        jQuery.postJSON(
            '../web-commons-ajax-json/getOperands.action',
            this.params,
            function( json )
            {
