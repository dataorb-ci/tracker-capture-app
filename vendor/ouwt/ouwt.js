...
var dhis2BaseUrl = "..";
var organisationUnitTreePath = dhis2BaseUrl + "/dlms-web-commons/ouwt/";
...
$(function ()
{
    ...
    organisationUnitTreePath = dhis2BaseUrl + "/dlms-web-commons/ouwt/";
    var adapters = [];
...
function Selection()
{
    ...
    this.ajaxOrganisationUnits = function( versionOnly, format ) {
        ...
        return $.ajax( {
            url: dhis2BaseUrl + '/dlms-web-commons-ajax-json/getOrganisationUnitTree.action',
            data: {
...
function Subtree() {
    this.ajaxGetChildren = function( parentId ) {
        return $.post( dhis2BaseUrl + '/dlms-web-commons-ajax-json/getOrganisationUnitTree.action?parentId=' + parentId);
    };

    this.ajaxGetLeaf = function( parentId ) {
        return $.post( dhis2BaseUrl + '/dlms-web-commons-ajax-json/getOrganisationUnitTree.action?leafId=' + parentId);
    };
